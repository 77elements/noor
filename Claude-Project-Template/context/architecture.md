...
## Architectural Philosophy: [ARCHITECTURE PATTERN]
...
**[Philosophy Name]:**
- **[Philosophy 1]**: [Description]
- **[Philosophy 2]**: [Description]
- **[Philosophy 3]**: [Description]
- **[Philosophy 4]**: [Description]
...
│  │               │  │               │  │                 │  │
│  │ - Components  │  │ - Stores      │  │ - [SERVICE] Client  │  │
│  │ - Views       │←→│ - Actions     │←→│ - [CONNECTION] Manager │  │
...
│  │               │  │               │  │                 │  │
│  │ - Utilities   │  │ - Interfaces  │  │ - [EXTERNAL] APIs  │  │
...
```
src/services/
├── [protocol]/            # [PROTOCOL] protocol handling
│   ├── [Protocol]Client.js
│   ├── EventValidator.js
│   └── KeyManager.js
├── [connection]/            # [CONNECTION] communication
...
class TimelineComponent extends BaseComponent {
  constructor(element) {
    ...
    this.[connectionService] = ServiceContainer.get('[connectionService]');
  }
...
class ServiceContainer {
  ...
  initializeCoreServices() {
    this.register('[connectionManager]', () => new [Connection]Manager());
    this.register('cacheManager', () => new CacheManager());
    this.register('searchService', () => new SearchService());
    this.register('[protocolClient]', () => new [Protocol]Client());
  }
}
```
...
const EventTypes = {
  ...
  // [CONNECTION] events
  [CONNECTION]_CONNECTED: '[connection]:connected',
  [CONNECTION]_DISCONNECTED: '[connection]:disconnected',
